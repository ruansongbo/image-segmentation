...
void Detection::paintEvent(QPaintEvent*)
{
	...
	ui.masterlabel->show();
	ui.masterlabel_2->setPixmap(QPixmap::fromImage(NGImg));
	ui.masterlabel_2->show();
	ui.masterlabel_3->setPixmap(QPixmap::fromImage(NGImg));
	ui.masterlabel_3->show();
	ui.masterlabel_4->setPixmap(QPixmap::fromImage(NGImg));
	ui.masterlabel_4->show();
	ui.masterlabel_5->setPixmap(QPixmap::fromImage(NGImg));
	ui.masterlabel_5->show();
	ui.Rsenlabel->setPixmap(QPixmap::fromImage(NGImg));
	ui.Rsenlabel->show();
	ui.Rsenlabel_2->setPixmap(QPixmap::fromImage(NGImg));
	ui.Rsenlabel_2->show();
	ui.Rsenlabel_3->setPixmap(QPixmap::fromImage(NGImg));
	ui.Rsenlabel_3->show();
	ui.Rsenlabel_4->setPixmap(QPixmap::fromImage(NGImg));
	ui.Rsenlabel_4->show();
